h1. Rails App for a Startup Prelaunch Signup Site
...
Read an "interview with Michael Gajda of XPlaygrounds.com":http://blog.railsapps.org/post/22543541226/powered-up-by-the-railsapps-project-xplaygrounds-com about how he used the "rails-prelaunch-signup":http://github.com/RailsApps/rails-prelaunch-signup/ example to launch his startup site. If you launch a site using this example, add your link to the list of "Rails Applications Built from the Examples":http://railsapps.github.com/rails-applications-from-examples.html. 
...
h3. Please Remember: Edit the README
