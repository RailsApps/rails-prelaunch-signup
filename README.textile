...
This is an example application for Rails 3.2 that shows how to create a Rails application for a startup prelaunch signup site.

The application is intended for Rails developers who want to build and deploy their own prelaunch site. The application is very simple and any experienced Rails developer could easily build it. The aim of the project is to eliminate individual effort building an application that meets a common need. As an open source project, you can use code that is already implemented and tested. Your individual effort can be better applied to add features to a prelaunch app, customize the look and functionality of your prelaunch site, and get started on a real application for a launch. See below for a discussion of "What Is Implemented — and What Is Not" including links to hosted alternatives. This is an application for Rails develoeprs who want to build their own prelaunch signup site.

This app extends the "rails3-devise-rspec-cucumber":https://github.com/RailsApps/rails3-devise-rspec-cucumber example app. "Devise":http://github.com/plataformatec/devise gives you ready-made authentication and user management.

Best of all, there's a "detailed tutorial":https://github.com/RailsApps/rails-prelaunch-signup/wiki/Tutorial (walk-through) to show how it's built.
...
h4. "View the Tutorial":https://github.com/RailsApps/rails-prelaunch-signup/wiki/Tutorial

The tutorial documents each step to follow to create the application. Every step is documented concisely, so a complete beginner can create this application without any additional knowledge. However, no explanation is offered for any of the steps, so if you are a beginner, you’re advised to look for an introduction to Rails elsewhere. See a list of "recommended resources for Rails":http://railsapps.github.com/best-recommended-learning-rails-books-resources.html.
...
Currently, the application only serves to display a landing page with a form for visitors to request invitations. Visitor's email addresses are collected in the application's database. An administrator can view the collected email addresses.
...
You can see a "list of user stories":https://github.com/RailsApps/rails-prelaunch-signup/blob/master/stories/implemented.html that have been implemented.
...
You can see a "list of user stories":https://github.com/RailsApps/rails-prelaunch-signup/blob/master/stories/unimplemented.html that have not been implemented. If you have ideas for additional features for this application, edit the file and submit a pull request. Or simply create a "GitHub issue":http://github.com/RailsApps/rails-prelaunch-signup/issues.
...
To build the "rails-prelaunch-signup" example application, run the command:
...
The application generator template will ask you for your preferences. To duplicate the example app exactly, choose the following preferences. Choose others to match what you prefer.
...
The "tutorial":https://github.com/RailsApps/rails-prelaunch-signup/wiki/Tutorial shows how a customized application template can be assembled from "recipes." The application template was created using the "Rails Apps Composer":https://github.com/RailsApps/rails_apps_composer gem which provides a convenient way to assemble a reusable application template by selecting various "recipes" for popular Rails development packages.
