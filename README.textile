...
Example "beta launching soon" application for Rails 3.2 that shows how to create a Rails application for a startup prelaunch signup site.
...
Best of all, there's a "detailed tutorial":https://github.com/RailsApps/rails-prelaunch-signup/wiki/Tutorial (walk-through) to show how it is built.
