...
You can see a "list of user stories":https://github.com/RailsApps/rails-prelaunch-signup/blob/master/stories/unimplemented.textile that have not been implemented. If you have ideas for additional features for this application, edit the file and submit a pull request. Or simply create a "GitHub issue":http://github.com/RailsApps/rails-prelaunch-signup/issues.
